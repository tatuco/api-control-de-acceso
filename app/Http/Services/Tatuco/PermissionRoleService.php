...
use App\Acl\Src\Models\PermissionRole;
use Illuminate\Http\Request;

class PermissionRoleService extends TatucoService
{
    public function __construct()
    {
        $this->name = 'permission_role';
        $this->model = new PermissionRole();
        $this->namePlural = 'permissions_roles';
    }
    ...
    public function index(Request $request){
        ...
        $query = PermissionRole::from('permission_role as pr')
            ->select('p.slug', 'p.description', 'r.name')
    ...
    public function show($x_pk)
    {
        ...
        //realizo el query
        $query = PermissionRole::find($x_pk);
