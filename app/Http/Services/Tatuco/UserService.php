...
class UserService extends TatucoService
{
    ...
    public function index(Request $request)
    {
        ...
        $query = User::from('users as u')
            ->select('u.use_dni','u.use_nam','u.use_lna','u.use_nic','u.email','u.sta_id','u.address','u.phone'
                , 'u.image', 'ru.role_id','ru.user_id', 'r.name', 's.name as sta_des', 't.name as typ_des')
