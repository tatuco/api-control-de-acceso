	...
	<div class="content">
		<table width="100%" class="table">
			...
			@foreach($results as $result)
                ...
                echo '<td class=""><b>' . number_format($total[$colName], 0, ',', '.') . '</b></td>';
                } elseif ($showTotalColumns[$colName] == 'idr') {
                echo '<td class=""><b>IDR ' . number_format($total[$colName], 0, ',', '.') . '</b></td>';
                } elseif ($showTotalColumns[$colName] == '$') {
                echo '<td class=""><b>$ ' . number_format($total[$colName], 2, ',', '.') . '</b></td>';
                }
                $dataFound = true;
                } else {
                if ($dataFound) {
