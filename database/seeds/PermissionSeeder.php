...
//
        ...
        DB::table('permissions')->insert([
            'name'=> 'store.contract',
            'slug'=>'store.contract',
            'description' => 'crear los contratos',
            'created_at'=> new DateTime,
            'updated_at'=> new DateTime
        ]);
        DB::table('permission_role')->insert([
        ...
        DB::table('permissions')->insert([
            ...
            'description' => 'modificar los contratos',
            'created_at'=> new DateTime,
            'updated_at'=> new DateTime
        ]);
        DB::table('permission_role')->insert([
        ...
        DB::table('permissions')->insert([
            ...
            'slug'=>'destroy.contract',
            'description' => 'eliminar los contratos',
            'created_at'=> new DateTime,
            'updated_at'=> new DateTime
        ]);
        DB::table('permission_role')->insert([
        ...
        DB::table('permissions')->insert([
            'name'=> 'show.contract',
            'slug'=>'show.contract',
            'description' => 'mostrar un contrato',
            'created_at'=> new DateTime,
            'updated_at'=> new DateTime
        ]);
        DB::table('permission_role')->insert([
